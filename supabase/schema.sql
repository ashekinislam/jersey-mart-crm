...
-- AI intake drafts (created via the ChatGPT Action integration; require
-- manual review/approval in the app before they become real records)
...
-- Reckon One OAuth connection (one per owner)
